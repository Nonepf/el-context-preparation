...
| 题号 | 题目 | 考察点 | 推荐时间 |
|------|------|--------|---------|
| 1 | 图中连通块个数（DFS） | DFS 基础 | 10 min |
| 2 | 迷宫最短路径（网格 BFS） | BFS | 20 min |
| 3 | Dijkstra 模板题：求起点到各点最短距离 | Dijkstra | 20 min |
| 4 | 拓扑排序模板题：输出任意合法拓扑序 | Kahn | 15 min |
| 5 | 课程表（检测能否完成所有课程 = 检测是否有环） | 拓扑排序 / DFS 判环 | 20 min |
| 6 | 判断二分图 | 染色法 | 20 min |
