...
>
> **预计时间**：3.5 小时阅读 + 0.5 小时练习（DP 重在理解，可以第二天再补练习）
...
| 题号 | 题目 | 考察点 | 推荐时间 |
|------|------|--------|---------|
| 1 | 经典 01 背包 | 背包模板 | 15 min |
| 2 | 完全背包（每种无限个） | 正序 vs 倒序 | 15 min |
| 3 | 最大子数组和 | Kadane | 10 min |
| 4 | 最长上升子序列 | LIS O(n log n) | 20 min |
| 5 | 打家劫舍 | 线性 DP | 15 min |
| 6 | 买卖股票最佳时机 | 状态机 DP | 20 min |
| 7 | 最长公共子序列 | 二维 DP | 20 min |
| 8 | 零钱兑换（最少硬币凑金额） | 完全背包变体 | 20 min |
