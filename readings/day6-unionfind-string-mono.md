...
| 题号 | 题目 | 考察点 | 推荐时间 |
|------|------|--------|---------|
| 1 | 朋友圈/省份数量 | 并查集基础 | 15 min |
| 2 | 滑动窗口最大值 | 单调队列 | 20 min |
| 3 | 下一个更大元素 | 单调栈 | 20 min |
| 4 | 柱状图中最大矩形 | 单调栈（进阶） | 25 min |
| 5 | 最长回文子串 | 字符串哈希 + 二分 | 25 min |
| 6 | 实现 Trie | Trie 树 | 15 min |
